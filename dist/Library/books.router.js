...
exports.LibraryRouter.get('/books', books_controller_1.getAllBooks);
exports.LibraryRouter.get('/books/:id', books_controller_1.getBook);
...
exports.LibraryRouter.delete('/books/:id', books_controller_1.deleteBookC);
